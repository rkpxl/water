  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        <p className="mb-8 border-b border-body-color border-opacity-10 pb-8 text-base leading-relaxed  font-[340] dark:border-white dark:border-opacity-10 dark:text-white">
          “{content}
        </p>
        <div className="flex items-center">
          ...
          <div className="w-full">
            ...
            <p className="text-sm  font-[340]">{designation}</p>
          </div>
        </div>
      </div>
    </div>
